...
/**
 * Formatea una fecha a formato DD/MM/YYYY (y opcionalmente incluye HH:MM:SS).
 * * NOTA TÉCNICA: Esta función renderiza la fecha utilizando la zona horaria local 
 * del sistema (runtime). Entradas con offset UTC pueden sufrir desplazamientos 
 * horarios al convertirse al huso local.
 */
